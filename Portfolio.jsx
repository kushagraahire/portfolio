...
import { Github, Linkedin, Code, Download, Mail, MapPin, Calendar, Award, GraduationCap, Briefcase, User, Zap, Star, Phone } from 'lucide-react';
...
const Portfolio = () => {
  ...
  // Skills data array
  const skills = [
    'Java 8/17', 'Spring Boot', 'Spring MVC', 'Hibernate ORM', 'JPA', 'RESTful APIs',
    'SQL', 'Oracle', 'Redis', 'Git', 'Bitbucket', 'Gradle', 'JUnit', 'IntelliJ Idea',
    'Microservices', 'Agile', 'Scrum', 'Generative AI (LLMs)', 'Prompt Engineering', 'CI/CD'
  ];
  ...
  const projects = [
    {
      title: 'QUBIT',
      description: 'Engineered a full-stack Q&A platform with Java, Spring Boot, and ReactJS, enabling seamless, secure collaboration for developers. Designed scalable backend APIs, integrated tag-based filtering, and implemented an upvote system to boost engagement.',
      tech: ['Java', 'Spring Boot', 'ReactJS', 'REST APIs'],
      github: 'https://github.com/kushagraahire/Qubit'
    },
    {
      title: 'POLARIS',
      description: 'Led end-to-end development of a real-time Bus Tracking System using Java, Firebase, Android Studio and Google Maps API. Implemented secure authentication and integrated live location tracking to streamline campus transit operations.',
      tech: ['Java', 'Firebase', 'Android Studio', 'Google Maps API'],
      github: 'https://github.com/kushagraahire/Polaris-Bus-Tracking-and-Management-System'
    }
  ];
              ...
              {['Home', 'Experience', 'Skills', 'Projects', 'Education', 'Contact'].map((item) => (
                <button
                  ...
                  className={`px-3 py-2 rounded-md text-sm font-medium transition-all duration-200 hover:bg-purple-500/20 hover:scale-105 ${
                    activeSection === item.toLowerCase() ? 'text-purple-400 bg-purple-500/10' : 'text-gray-300 hover:text-white'
                  }`}
                >
                  {item}
                </button>
  ...
  const HeroSection = () => (
    <section id="home" className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-purple-900/20 via-blue-900/20 to-gray-900">
      <div className="max-w-7xl mx-auto text-center mt-16">
        <div className="mb-8">
          ...
          <div className="w-40 h-40 mx-auto rounded-full bg-gradient-to-r from-purple-500 to-blue-500 p-1 mb-8">
            <div className="w-full h-full rounded-full bg-gray-900 flex items-center justify-center">
              <img src={profile} alt='Profile' className='rounded-full object-cover w-full h-full'/>
            </div>
          </div>
        ...
        <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
          Passionate Backend Developer specializing in building robust, scalable microservices architectures.
          I turn complex business requirements into clean, efficient technical solutions, with strong expertise in the Java ecosystem and cloud-native technologies. Currently developing high-performance systems for the banking domain.
        </p>
        ...
        <div className="flex justify-center space-x-8 mb-8">
          <a href="https://github.com/kushagraahire" className="text-gray-400 hover:text-purple-400 transition-all duration-300 transform hover:scale-110">
            <Github className="w-8 h-8" />
          </a>
          <a href="https://www.linkedin.com/in/kushagraahire/" className="text-gray-400 hover:text-blue-400 transition-all duration-300 transform hover:scale-110">
            <Linkedin className="w-8 h-8" />
          </a>
          <a href="https://leetcode.com/u/kushagraahire/" className="text-gray-400 hover:text-yellow-400 transition-all duration-300 transform hover:scale-110">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-12">
          {experiences.map((exp, index) => (
            <div key={index} className="bg-gray-800/30 backdrop-blur-sm border border-gray-700 rounded-xl p-8 hover:bg-gray-800/50 transition-all duration-300">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <div key={index} className="bg-gray-800/30 backdrop-blur-sm border border-gray-700 rounded-xl p-8 hover:bg-gray-800/50 transition-all duration-300 transform hover:scale-105">
          ...
          <div className="bg-gray-800/30 backdrop-blur-sm border border-gray-700 rounded-xl p-8">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-300">Shri Vaishnav Institute of Information Technology (SVIIT)</p>
                <p className="text-gray-400">2019-2023 | Indore, India</p>
                <p className="text-purple-400 font-medium">CGPA: 7.48/10</p>
              </div>
              <div className="border-t border-gray-700 pt-4">
                <h5 className="text-lg font-medium text-gray-300 mb-2">Core Coursework:</h5>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                  {['Object Oriented Programming (OOP)', 'Database Management System (DBMS)', 'Operating Systems', 'Computer Networks', 'Data Structures and Algorithms (DSA)', 'System Design'].map((course, i) => (
        ...
        <div className="max-w-4xl mx-auto mt-12">
          ...
          <div className="bg-gray-800/30 backdrop-blur-sm border border-gray-700 rounded-xl p-8">
            <div className="flex items-center mb-6">
              ...
              <h4 className="text-xl font-bold text-blue-400">Industry Recognition</h4>
            </div>
            <div className="flex items-center">
              ...
              <div>
                <h5 className="text-lg font-semibold text-white">Microsoft AZ-900: Azure Fundamentals</h5>
                <p className="text-gray-400">Certified 2024 | Cloud Computing & Azure Services</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="contact" className="py-20 px-4">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
          Ready to build something amazing together? I'm always excited to discuss new 
          opportunities, innovative projects, and creative collaborations. Let's connect!
        </p>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-12 mb-12">
          <div className="flex items-center space-x-4">
            ...
            <a href="mailto:kushagraahire11@gmail.com" className="text-xl text-gray-300 hover:text-purple-400 transition-colors">
              kushagraahire11@gmail.com
            </a>
          </div>
          <div className="flex items-center space-x-4">
            <Phone className="w-6 h-6 text-blue-400" />
            <a href="tel:+918889975573" className="text-xl text-gray-300 hover:text-blue-400 transition-colors">
              +91 8889975573
            </a>
          </div>
        </div>
        ...
        <div className="flex justify-center space-x-8">
          <a href="https://github.com/kushagraahire" className="bg-gray-800 hover:bg-gray-700 p-4 rounded-full transition-all duration-300 transform hover:scale-110">
            <Github className="w-8 h-8 text-white" />
          </a>
          <a href="https://www.linkedin.com/in/kushagraahire/" className="bg-blue-600 hover:bg-blue-700 p-4 rounded-full transition-all duration-300 transform hover:scale-110">
            <Linkedin className="w-8 h-8 text-white" />
          </a>
          <a href="https://leetcode.com/u/kushagraahire/" className="bg-yellow-600 hover:bg-yellow-700 p-4 rounded-full transition-all duration-300 transform hover:scale-110">
